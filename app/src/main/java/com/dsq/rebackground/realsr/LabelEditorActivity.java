...
public class LabelEditorActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.btn_copy_all).setOnClickListener(v -> {
            ...
            ToastUtil.showToast(this, R.string.label_copied, Toast.LENGTH_SHORT);
        });
        ...
        findViewById(R.id.btn_paste_all).setOnClickListener(v -> {
            ...
            if (clipboard.hasPrimaryClip() && clipboard.getPrimaryClip() != null
                ...
                if (text != null) {
                    ...
                    ToastUtil.showToast(this, R.string.label_clipboard_empty, Toast.LENGTH_SHORT);
                }
            } else {
                ToastUtil.showToast(this, R.string.label_clipboard_empty, Toast.LENGTH_SHORT);
            }
        ...
        findViewById(R.id.btn_clear_all).setOnClickListener(v -> {
            ...
            adapter.notifyDataSetChanged();
            ToastUtil.showToast(this, R.string.label_cleared, Toast.LENGTH_SHORT);
        });
        ...
        findViewById(R.id.btn_label_save).setOnClickListener(v -> {
            ...
            ToastUtil.showToast(this, R.string.save_succeed, Toast.LENGTH_SHORT);
            finish();
        });
    }
